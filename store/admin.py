...
class CustomerAdmin(admin.ModelAdmin):
    ...
    def order_count(self, customer):
        url = reverse('admin:store_order_changelist') + f'?customer__id={customer.id}'
...
class CollectionAdmin(admin.ModelAdmin):
    ...
    def product_count(self, collection):
        url = reverse('admin:store_product_changelist') + f'?{urlencode({'collection__id': collection.id})}'
